...
$content = '';
    ...
    $content .= '<h3 class="text-center">List of Member</h3>
...
$pdf->Output('MembersList_report.pdf', 'I');
...
<body>
    ...
    <h1 class="text-info text-center mb-5">List of Members</h1>
        <div class="table-responsive">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <a class="btn btn-info " href="./members.php">Return Back</a>
            </div>
        </div>
    </div>
